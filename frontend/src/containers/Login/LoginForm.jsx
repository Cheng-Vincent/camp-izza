                ...
                <Col>
                    <Form class="login-form" noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Form.Group as={Col} controlID="validationPasswordInput" className="mb-4">
                            ...
                            <a href="/" class="mb-4">Forgot Password?</a>
                        </Form.Group>
                        <Row><p class="login-error-message">{errorMessage}</p></Row>
                        <Row>
                            <Stack gap={2} className="mx-auto">
                                <Button className="login-button btn-lg mb-4 mx-auto" type="submit">LOG IN</Button>
                                <Button className="register-button btn-lg mb-4 mx-auto" variant="outline-primary" href="/registration" type="button">NEW HERE? REGISTER</Button>
                            </Stack>
                        </Row>
                    </Form>
                </Col>
