...
const ParentDetailsForm = () => {
  ...
  const saveInfo = (e) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      e.preventDefault();
      Axios.post(
        process.env.REACT_APP_YSS_BACKEND_SERVER + "/submitParentDetails",
        {
          parentID: parentID,
          parentBirthday: parentBirthday,
          parentPhone: parentPhone,
    ...
    <>
      ...
      <div className="container registration-container">
        <Row className="mb-4 mx-auto">
          <Col>
            <h1>Parent/Guardian Details Form</h1>
          </Col>
        </Row>
        <Row className="mx-auto">
          <Form as={Col} noValidate validated={validated}>
            <Row className="mb-4">
              <Form.Group as={Col}>
