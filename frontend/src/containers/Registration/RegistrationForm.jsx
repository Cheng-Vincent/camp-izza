...
const RegistrationForm = () => {
  ...
  const sendConfirmEmail = () => {
    Axios.post(process.env.REACT_APP_YSS_BACKEND_SERVER + "/sendConfirmEmail", {
      email: form.email,
        ...
        <Col className="mb-4">
          <Form class="registration-form" onSubmit={handleSubmit}>
            <Row as={Col} className="mb-4">
              <label class="mr-4">
                What are you registering as? <br />
                (If you are a youth participant, a parent/guardian must do this
                part)
              </label>
            ...
            <Row>
              <Stack gap={2} className="mx-auto">
                <Button className="btn-lg mb-4 mx-auto" type="submit">
                  REGISTER
                </Button>
                <Button
                  className="btn-lg mb-4 mx-auto"
